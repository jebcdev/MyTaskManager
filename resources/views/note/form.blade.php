<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="task_id" class="form-label">{{ __('Task Id') }}</label>
            <input type="text" name="task_id" class="form-control @error('task_id') is-invalid @enderror" value="{{ old('task_id', $note?->task_id) }}" id="task_id" placeholder="Task Id">
