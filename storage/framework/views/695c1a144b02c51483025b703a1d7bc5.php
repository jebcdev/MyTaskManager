...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $category?->name)); ?>" id="name" placeholder="<?php echo e(__('Name')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('description', $category?->description)); ?>" id="description" placeholder="<?php echo e(__('Description')); ?>">
...
</div><?php /**PATH D:\laragon\www\MyTaskManager\resources\views/category/form.blade.php ENDPATH**/ ?>